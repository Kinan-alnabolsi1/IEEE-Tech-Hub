...
import Loader from '../../../components/ui/Loader'; // 🌟 1. استيراد اللودر (تأكدي من صحة المسار لديكِ)
...
const AdminsManagement = () => {
  ...
  return (
    <>
      {/* 🌟 2. إضافة اللودر ليغطي الشاشة أثناء التحميل */}
      {isLoading && <Loader message={`Loading ${activeTab} admins...`} />}
