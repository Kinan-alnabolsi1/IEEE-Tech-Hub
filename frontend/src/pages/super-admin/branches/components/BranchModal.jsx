  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title={initialData ? "Edit Infrastructure" : "New Integration"}>
      <form onSubmit={handleSubmit} className="space-y-4 mt-2">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input 
              ...
              required 
              type="text" 
              placeholder="e.g. IEEE Damascus University"
        ...
        {/* الصف الثاني: المنطقة + تاريخ التأسيس (جنب بعض) */}
        ...
        {/* الصف الثالث: الإيميل + الهاتف (جنب بعض) */}
        <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
